import { ProjectsLegacySprintBoardActions } from './projects-legacy-sprint-board-actions';
import {
  AppException,
...
export abstract class ProjectsLegacySprintActions extends ProjectsLegacySprintBoardActions {
